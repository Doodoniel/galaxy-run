...
export const PITCH_TEMPLATE = [
  { text: 'Hello, Richie! Welcome to planet ', gap: 'name', hint: 'planet name' },
  { text: '. It is ', gap: 'adj1', hint: 'e.g. bright' },
  { text: ' and ', gap: 'adj2', hint: 'e.g. friendly' },
  { text: '. On my planet you can ', gap: 'can', hint: 'e.g. fly with dragons' },
  { text: '. You will learn the words ', gap: 'w1', hint: 'word 1' },
  { text: ', ', gap: 'w2', hint: 'word 2' },
  { text: ' and ', gap: 'w3', hint: 'word 3' },
  { text: '. Come to my planet and ', gap: 'invite', hint: 'e.g. make new friends' },
  { text: '!', gap: null, hint: '' },
] as const;
...
export const STAGE_META: Record<StageId, { title: string; sub: string; minutes: string }> = {
  liftoff: { title: 'Lift-off', sub: 'Callsigns and crew', minutes: '0–4' },
  wordlab: { title: 'Word Lab', sub: '10 new words', minutes: '4–14' },
  challenge: { title: 'Chameleon Challenge', sub: '60 seconds, 10 words', minutes: '14–19' },
  picture: { title: 'Picture This', sub: 'Listen, draw, retell', minutes: '19–29' },
  storycheck: { title: 'Story Check', sub: 'True / false + meteors', minutes: '29–36' },
  run: { title: 'Galaxy Run', sub: 'The board race', minutes: '36–53' },
  planet: { title: 'My Planet', sub: 'Design it, pitch it', minutes: '53–58' },
  landing: { title: 'Landing', sub: 'Stars, MVP, homework', minutes: '58–60' },
};
